...
BIRD_DIR = '/mnt/62645850645828D5/Ubuntu_files/causalidade_datasets/CUB_200_2011/'
...
def save_data_list(inpath, outpath, filenames, filename_bbox):
    ...
    for key in filenames:
        ...
        # save image
        scipy.misc.imsave(os.path.join(outpath, "{:06d}.jpg".format(cnt+1)), img)
...
def convert_birds_dataset_pickle(inpath):
    ...
    # print(filename_bbox)
    f_images = open(os.path.join(inpath, "CUB_200_2011", "images.txt"), "r")
    filenames = get_images_names(f_images)
    f_images.close()

    save_data_list(inpath, "/home/renato/Dev/CausalGAN/data/images/", filenames, filename_bbox)
    # ## For Train data
